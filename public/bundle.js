...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Coroutine"] = $PS["Coroutine"] || {};
  var exports = $PS["Coroutine"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad = $PS["Control.Monad"];
  ...
  var CoroutineT = function (x) {
      return x;
  };
  var $$yield = function (dictMonad) {
      return function (x) {
          return function (continuation) {
              return CoroutineT(Control_Applicative.pure(dictMonad.Applicative0())(Data_Either.Left.create(new Yield(x, continuation))));
          };
      };
  };
  var newtypeCoroutineT = new Data_Newtype.Newtype(function (n) {
      return n;
  }, CoroutineT);
  var monadTransCoroutineT = new Control_Monad_Trans_Class.MonadTrans(function (dictMonad) {
      var $41 = Control_Monad.liftM1(dictMonad)(Data_Either.Right.create);
      return function ($42) {
          return CoroutineT($41($42));
      };
  });
  var functorYield = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new Yield(m.value0, Data_Functor.map(Data_Functor.functorFn)(f)(m.value1));
      };
  });
  var functorCoroutineT = function (dictFunctor) {
      return function (dictFunctor1) {
          return new Data_Functor.Functor(function (f) {
              return function (v) {
                  return CoroutineT(Data_Functor.map(dictFunctor1)(Data_Either.either((function () {
                      var $43 = Data_Functor.map(dictFunctor)(Data_Functor.map(functorCoroutineT(dictFunctor)(dictFunctor1))(f));
                      return function ($44) {
                          return Data_Either.Left.create($43($44));
                      };
                  })())(function ($45) {
                      return Data_Either.Right.create(f($45));
                  }))(v));
              };
          });
      };
  };
  var done = function (dictMonad) {
      var $46 = Control_Applicative.pure(dictMonad.Applicative0());
      return function ($47) {
          return CoroutineT($46(Data_Either.Right.create($47)));
      };
  };
  var bounce = Data_Newtype.unwrap(newtypeCoroutineT);
  var monadCoroutineT = function (dictFunctor) {
      return function (dictMonad) {
          return new Control_Monad.Monad(function () {
              return applicativeCoroutineT(dictFunctor)(((dictMonad.Bind1()).Apply0()).Functor0())(dictMonad);
          }, function () {
              return bindCoroutineT(dictFunctor)(dictMonad);
          });
      };
  };
  var bindCoroutineT = function (dictFunctor) {
      return function (dictMonad) {
          return new Control_Bind.Bind(function () {
              return applyCoroutineT(dictFunctor)(dictMonad);
          }, function (v) {
              return function (f) {
                  return CoroutineT(Control_Bind.bind(dictMonad.Bind1())(v)(Data_Either.either((function () {
                      var $48 = Control_Applicative.pure(dictMonad.Applicative0());
                      var $49 = Data_Functor.map(dictFunctor)(function (v1) {
                          return Control_Bind.bind(bindCoroutineT(dictFunctor)(dictMonad))(v1)(f);
                      });
                      return function ($50) {
                          return $48(Data_Either.Left.create($49($50)));
                      };
                  })())(function ($51) {
                      return bounce(f($51));
                  })));
  ...
  var applyCoroutineT = function (dictFunctor) {
      return function (dictMonad) {
          return new Control_Apply.Apply(function () {
              return functorCoroutineT(dictFunctor)(((dictMonad.Bind1()).Apply0()).Functor0());
          }, Control_Monad.ap(monadCoroutineT(dictFunctor)(dictMonad)));
      };
  };
  var applicativeCoroutineT = function (dictFunctor) {
      return function (dictFunctor1) {
          return function (dictMonad) {
              return new Control_Applicative.Applicative(function () {
                  return applyCoroutineT(dictFunctor)(dictMonad);
                  ...
                  var $53 = Control_Applicative.pure(Data_Either.applicativeEither);
                  return function ($54) {
                      return CoroutineT($52($53($54)));
                  };
              })());
          };
      };
  ...
  exports["yield"] = $$yield;
  exports["done"] = done;
  exports["CoroutineT"] = CoroutineT;
  exports["bounce"] = bounce;
  exports["functorYield"] = functorYield;
  exports["newtypeCoroutineT"] = newtypeCoroutineT;
  exports["functorCoroutineT"] = functorCoroutineT;
  exports["applicativeCoroutineT"] = applicativeCoroutineT;
  exports["bindCoroutineT"] = bindCoroutineT;
  exports["monadTransCoroutineT"] = monadTransCoroutineT;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Lang.Core"] = $PS["Lang.Core"] || {};
  var exports = $PS["Lang.Core"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Error_Class = $PS["Control.Monad.Error.Class"];
  ...
  var FloatTipe = (function () {
      function FloatTipe() {

      };
      FloatTipe.value = new FloatTipe();
      return FloatTipe;
  })();
  var IntegerTipe = (function () {
      function IntegerTipe() {

      };
      IntegerTipe.value = new IntegerTipe();
      return IntegerTipe;
  })();
  ...
  var TrueCondClauseNotFound = (function () {
      function TrueCondClauseNotFound() {

      };
      TrueCondClauseNotFound.value = new TrueCondClauseNotFound();
      return TrueCondClauseNotFound;
  })();
  ...
  var toExprTipe = function (v) {
      ...
      if (v.value0 instanceof Float) {
          return FloatTipe.value;
      };
      if (v.value0 instanceof Integer) {
          return IntegerTipe.value;
      };
      throw new Error("Failed pattern match at Lang.Core (line 224, column 3 - line 236, column 18): " + [ v.value0.constructor.name ]);
  };
  var $$throw = function (dictMonadThrow) {
      return function (ann) {
          return function (name) {
              return Control_Monad_Error_Class.throwError(dictMonadThrow)(new EvalErr(name, ann.srcSpan));
          };
      };
  };
  var showSFrm = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Lang.Core (line 186, column 1 - line 198, column 23): " + [ v.constructor.name ]);
  });
  ...
  var showExpr = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Lang.Core (line 140, column 1 - line 147, column 52): " + [ v.constructor.name ]);
  });
  var showEvalErr = new Data_Show.Show(function (v) {
      ...
      if (v.value0 instanceof LstLength) {
          return "wrong list length " + Data_Show.show(Data_Show.showInt)(v.value0.value0.received);
      };
      ...
      if (v.value0 instanceof TrueCondClauseNotFound) {
          return "cond found no true predicates. Add an `else` clause at the end.";
      };
      throw new Error("Failed pattern match at Lang.Core (line 81, column 5 - line 95, column 74): " + [ v.value0.constructor.name ]);
  });
  var sfrmNumArgs = function (v) {
      ...
      throw new Error("Failed pattern match at Lang.Core (line 200, column 1 - line 200, column 27): " + [ v.constructor.name ]);
  };
  var semigroupPrimFns = new Data_Semigroup.Semigroup(function (v) {
      return function (v1) {
          return Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(v)(v1);
      };
  });
  var resultWithEnv = function (v) {
      return new Data_Tuple.Tuple(v.value0, v.value1.bindings);
  };
  var newtypeEvalT = new Data_Newtype.Newtype(function (n) {
      return n;
  }, EvalT);
  var runEvalT = function (dictMonad) {
      return function (bindings) {
          return function (evaled) {
              ...
              var rn = (function () {
                  var $140 = Data_Function.flip(Control_Monad_State_Trans.runStateT)(evalState);
                  var $141 = Data_Newtype.unwrap(newtypeEvalT);
                  return function ($142) {
                      return $140(Control_Monad_Except_Trans.runExceptT($141($142)));
                  };
              })();
              return Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(resultWithEnv)(rn(evaled));
          };
      };
  };
  var newtypeBindings = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Bindings);
  var monoidPrimFns = new Data_Monoid.Monoid(function () {
      return semigroupPrimFns;
  }, Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString)));
  var monoidBindings = function (dictMonoid) {
      return Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
          return "env";
      }))(Data_Map_Internal.monoidMap(Data_Ord.ordString))()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
          return "primFns";
      }))(dictMonoid)()(Data_Monoid.monoidRecordNil)));
  };
  var monadThrowEvalT = function (dictMonad) {
      return Control_Monad_Except_Trans.monadThrowExceptT(Control_Monad_State_Trans.monadStateT(dictMonad));
  };
  var monadStateEvalT = function (dictMonad) {
      return Control_Monad_Except_Trans.monadStateExceptT(Control_Monad_State_Trans.monadStateStateT(dictMonad));
  };
  var updateEnv = function (dictMonad) {
      return function (key) {
          return function (val) {
              return Control_Monad_State_Class.modify_(monadStateEvalT(dictMonad))(function (v) {
                  return EvalState({
                      bindings: {
                          env: Data_Map_Internal.insert(Data_Ord.ordString)(key)(val)(v.bindings.env),
                          primFns: v.bindings.primFns
                      }
                  });
              });
          };
  ...
  var monadEvalT = function (dictMonad) {
      return Control_Monad_Except_Trans.monadExceptT(Control_Monad_State_Trans.monadStateT(dictMonad));
  };
  var mkTrue = function (ann) {
      return new ExprAnn(new Sym("true"), ann);
  };
  var mkFalse = function (ann) {
      return new ExprAnn(new Sym("false"), ann);
  };
  var isTrue = function (v) {
      if (v.value0 instanceof Lst && v.value0.value0 instanceof Data_List_Types.Nil) {
          return false;
      };
      if (v.value0 instanceof Sym && v.value0.value0 === "false") {
          return false;
      };
      return true;
  };   
  ...
  var getEnv = function (dictMonad) {
      return Control_Bind.bind(bindEvalT(dictMonad))(Control_Monad_State_Class.get(monadStateEvalT(dictMonad)))((function () {
          var $145 = Control_Applicative.pure(applicativeEvalT(dictMonad));
          var $146 = Data_Newtype.unwrap(newtypeBindings);
          var $147 = Data_Newtype.unwrap(evalStateNewtype);
          return function ($148) {
  ...
  exports["TrueCondClauseNotFound"] = TrueCondClauseNotFound;
  exports["Sym"] = Sym;
  exports["SFrm"] = SFrm;
  exports["Fn"] = Fn;
  exports["Lst"] = Lst;
  ...
  exports["newtypeEvalT"] = newtypeEvalT;
  exports["functorEvalT"] = functorEvalT;
  exports["applicativeEvalT"] = applicativeEvalT;
  exports["bindEvalT"] = bindEvalT;
  exports["monadEvalT"] = monadEvalT;
  exports["monadStateEvalT"] = monadStateEvalT;
  exports["monadThrowEvalT"] = monadThrowEvalT;
  exports["showEvalErr"] = showEvalErr;
  exports["showExprAnn"] = showExprAnn;
  exports["monoidBindings"] = monoidBindings;
  exports["monoidPrimFns"] = monoidPrimFns;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Lang.Eval"] = $PS["Lang.Eval"] || {};
  var exports = $PS["Lang.Eval"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Control_Monad_State_Trans = $PS["Control.Monad.State.Trans"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Coroutine = $PS["Coroutine"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_HeytingAlgebra = $PS["Data.HeytingAlgebra"];
  ...
  var Data_Traversable = $PS["Data.Traversable"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Lang_Core = $PS["Lang.Core"];                
  var wrongTipeErr = function (expected) {
      return function (received) {
          return new Lang_Core.WrongTipe({
              expected: expected,
              received: received
          });
      };
  ...
  var unknownVarErr = function (varName) {
      return new Lang_Core.UnknownVar({
          varName: varName
      });
  };
  var unknownErr = Lang_Core.UnknownErr.value;
  var trueCondClauseNotFound = Lang_Core.TrueCondClauseNotFound.value;
  var throwWrongTipeErr = function (dictMonadThrow) {
      return function (ann) {
          return function (expected) {
              return function (received) {
                  return Lang_Core["throw"](dictMonadThrow)(ann)(wrongTipeErr(expected)(received));
              };
          };
      };
  };
  var throwUnknownVarErr = function (dictMonadThrow) {
      return function (ann) {
          return function (varName) {
              return Lang_Core["throw"](dictMonadThrow)(ann)(unknownVarErr(varName));
          };
      };
  };
  var throwUnknownErr = function (dictMonadThrow) {
      return function (ann) {
          return Lang_Core["throw"](dictMonadThrow)(ann)(unknownErr);
      };
  };
  var throwTrueCondClauseNotFound = function (dictMonadThrow) {
      return function (ann) {
          return Lang_Core["throw"](dictMonadThrow)(ann)(trueCondClauseNotFound);
      };
  };
  var numArgsErr = function (expected) {
      return function (received) {
          return new Lang_Core.NumArgs({
              expected: expected,
              received: received
          });
      };
  };
  var throwNumArgsErr = function (dictMonadThrow) {
      return function (ann) {
          return function (expected) {
              return function (received) {
                  return Lang_Core["throw"](dictMonadThrow)(ann)(numArgsErr(expected)(received));
              };
          };
      };
  };
  var throwSFrmNumArgsErr = function (dictMonadThrow) {
      return function (ann) {
          return function (sfrm) {
              return function (args) {
                  var received = Data_Foldable.length(Data_List_Types.foldableList)(Data_Semiring.semiringInt)(args);
                  var expected = Lang_Core.sfrmNumArgs(sfrm);
                  return throwNumArgsErr(dictMonadThrow)(ann)(expected)(received);
              };
          };
      };
  };
  var lstLengthErr = function (expected) {
      return function (received) {
          return new Lang_Core.LstLength({
              expected: expected,
              received: received
          });
      };
  };
  var throwLstLengthErr = function (dictMonadThrow) {
      return function (ann) {
          return function (expected) {
              return function (received) {
                  return Lang_Core["throw"](dictMonadThrow)(ann)(lstLengthErr(expected)(received));
              };
          };
      };
  };
  var evalSym = function (dictMonad) {
      return function (ann) {
          return function (name) {
              return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(Lang_Core.getEnv(dictMonad)))(function (v) {
                  var v1 = Data_Map_Internal.lookup(Data_Ord.ordString)(name)(v);
                  if (v1 instanceof Data_Maybe.Just) {
                      return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v1.value0);
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwUnknownVarErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(name));
                  };
                  throw new Error("Failed pattern match at Lang.Eval (line 155, column 3 - line 159, column 41): " + [ v1.constructor.name ]);
              });
          };
      };
  };
  var evalQuote = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
                  return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v.value0);
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Quote.value)(v));
          };
      };
  };
  var evalPause = function (dictMonad) {
      return function (ann) {
          return function (v) {
              return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(Control_Monad_State_Class.get(Lang_Core.monadStateEvalT(dictMonad))))(function (v1) {
                  return Coroutine["yield"](Lang_Core.monadEvalT(dictMonad))(v1.bindings)(function (v2) {
                      return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(Lang_Core.mkFalse(ann));
                  });
              });
          };
      };
  };
  var evalLambda = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
                  if (v.value0.value0 instanceof Lang_Core.Lst) {
                      return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(Lang_Core.getEnv(dictMonad)))(function (v1) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(new Lang_Core.ExprAnn(new Lang_Core.Fn(v1, v.value0.value0.value0, v.value1.value0), ann));
                      });
                  };
                  return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.LstTipe.value)(Lang_Core.toExprTipe(v.value0)));
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Lambda.value)(v));
          };
      };
  };
  var emptyFnApplicationErr = Lang_Core.EmptyFnApplication.value;
  var throwEmptyFnApplicationErr = function (dictMonadThrow) {
      return function (ann) {
          return Lang_Core["throw"](dictMonadThrow)(ann)(emptyFnApplicationErr);
      };
  };
  var bindArgs = function (dictMonad) {
      return function (ann) {
          return function (localEnv) {
              return function (params) {
                  return function (args) {
                      var toParamName = function (v) {
                          if (v.value0 instanceof Lang_Core.Sym) {
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v.value0.value0);
                          };
                          return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.SymTipe.value)(Lang_Core.toExprTipe(v)));
                      };
                      var toBinding = function (param) {
                          return function (arg) {
                              return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(toParamName(param))(function (v) {
                                  return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(new Data_Tuple.Tuple(v, arg));
                              });
                          };
                      };
                      return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Data_Functor.map(Coroutine.functorCoroutineT(Coroutine.functorYield)(Lang_Core.functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0())))(Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_List_Types.foldableList))(Data_Traversable.sequence(Data_List_Types.traversableList)(Coroutine.applicativeCoroutineT(Coroutine.functorYield)(Lang_Core.functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0()))(Lang_Core.monadEvalT(dictMonad)))(Data_List.zipWith(toBinding)(params)(args))))(function (v) {
                          return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(Control_Monad_State_Class.get(Lang_Core.monadStateEvalT(dictMonad))))(function (v1) {
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(Lang_Core.EvalState({
                                  bindings: Lang_Core.Bindings({
                                      env: Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(v)(Data_Semigroup.append(Data_Map_Internal.semigroupMap(Data_Ord.ordString))(localEnv)(v1.bindings.env)),
                                      primFns: v1.bindings.primFns
                                  })
                              }));
                          });
                      });
  ...
  var evalSFrm = function (dictMonad) {
      return function (ann) {
          return function (v) {
              return function (v1) {
                  if (v instanceof Lang_Core.Conz) {
                      return evalConz(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Car) {
                      return evalCar(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Cdr) {
                      return evalCdr(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Cond) {
                      return evalCond(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Def) {
                      return evalDef(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Do) {
                      return evalDo(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.If) {
                      return evalIf(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.IsAtm) {
                      return evalIsAtm(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.IsEq) {
                      return evalIsEq(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Lambda) {
                      return evalLambda(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Pause) {
                      return evalPause(dictMonad)(ann)(v1);
                  };
                  if (v instanceof Lang_Core.Quote) {
                      return evalQuote(dictMonad)(ann)(v1);
                  };
                  if (v1 instanceof Data_List_Types.Nil) {
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(v)(Data_List_Types.Nil.value));
                  };
                  throw new Error("Failed pattern match at Lang.Eval (line 163, column 1 - line 163, column 71): " + [ ann.constructor.name, v.constructor.name, v1.constructor.name ]);
              };
          };
      };
  };
  var evalLst = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons) {
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Data_Traversable.traverse(Data_List_Types.traversableList)(Coroutine.applicativeCoroutineT(Coroutine.functorYield)(Lang_Core.functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0()))(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad))(v.value1))(function (v2) {
                          if (v1.value0 instanceof Lang_Core.Fn) {
                              return applyLambda(dictMonad)(ann)(v1.value0.value0)(v1.value0.value1)(v2)(v1.value0.value2);
                          };
                          return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.FnTipe.value)(Lang_Core.toExprTipe(v1)));
                      });
                  });
              };
              if (v instanceof Data_List_Types.Nil) {
                  return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwEmptyFnApplicationErr(Lang_Core.monadThrowEvalT(dictMonad))(ann));
              };
              throw new Error("Failed pattern match at Lang.Eval (line 331, column 1 - line 331, column 62): " + [ ann.constructor.name, v.constructor.name ]);
          };
      };
  };
  var evalIsEq = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
                  var t = Lang_Core.mkTrue(ann);
                  var f = Lang_Core.mkFalse(ann);
                  var evalIsEqLst = function (xs) {
                      return function (ys) {
                          return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Data_Traversable.traverse(Data_List_Types.traversableList)(Coroutine.applicativeCoroutineT(Coroutine.functorYield)(Lang_Core.functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0()))(Lang_Core.monadEvalT(dictMonad)))(evalIsEqExprPair)(Data_List.zip(xs)(ys)))(function (v1) {
                              var isNotEmpty = !Data_List["null"](v1);
                              var isAllEqual = Data_Foldable.all(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Lang_Core.isTrue)(v1);
                              var $119 = isNotEmpty && isAllEqual;
                              if ($119) {
                                  return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                              };
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(f);
                          });
                      };
                  };
                  var evalIsEqExprPair = function (v1) {
                      return evalIsEqExpr(v1.value0.value0)(v1.value1.value0);
                  };
                  var evalIsEqExpr = function (x) {
                      return function (y) {
                          var v1 = new Data_Tuple.Tuple(x, y);
                          if (v1.value0 instanceof Lang_Core.Float && v1.value1 instanceof Lang_Core.Float) {
                              var $128 = v1.value0.value0 === v1.value1.value0;
                              if ($128) {
                                  return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                              };
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(f);
                          };
                          if (v1.value0 instanceof Lang_Core.Integer && v1.value1 instanceof Lang_Core.Integer) {
                              var $133 = v1.value0.value0 === v1.value1.value0;
                              if ($133) {
                                  return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                              };
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(f);
                          };
                          if (v1.value0 instanceof Lang_Core.Sym && v1.value1 instanceof Lang_Core.Sym) {
                              var $138 = v1.value0.value0 === v1.value1.value0;
                              if ($138) {
                                  return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                              };
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(f);
                          };
                          if (v1.value0 instanceof Lang_Core.Lst && (v1.value0.value0 instanceof Data_List_Types.Nil && (v1.value1 instanceof Lang_Core.Lst && v1.value1.value0 instanceof Data_List_Types.Nil))) {
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                          };
                          if (v1.value0 instanceof Lang_Core.Lst && v1.value1 instanceof Lang_Core.Lst) {
                              return evalIsEqLst(v1.value0.value0)(v1.value1.value0);
                          };
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(f);
                      };
                  };
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value1.value0))(function (v2) {
                          return evalIsEqExpr(v1.value0)(v2.value0);
                      });
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.IsEq.value)(v));
          };
      };
  };
  var evalIsAtm = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
                  var t = Lang_Core.mkTrue(ann);
                  var f = Lang_Core.mkFalse(ann);
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      if (v1.value0 instanceof Lang_Core.Float) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                      };
                      if (v1.value0 instanceof Lang_Core.Integer) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                      };
                      if (v1.value0 instanceof Lang_Core.Sym) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(t);
                      };
                      return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(f);
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.IsAtm.value)(v));
          };
      };
  };
  var evalIf = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value1 instanceof Data_List_Types.Cons && v.value1.value1.value1 instanceof Data_List_Types.Nil))) {
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      var $175 = Lang_Core.isTrue(v1);
                      if ($175) {
                          return $$eval(dictMonad)(v.value1.value0);
                      };
                      return $$eval(dictMonad)(v.value1.value1.value0);
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.If.value)(v));
          };
      };
  };
  var evalDo = function (dictMonad) {
      return function (ann) {
          return function (args) {
              return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Data_Traversable.traverse(Data_List_Types.traversableList)(Coroutine.applicativeCoroutineT(Coroutine.functorYield)(Lang_Core.functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0()))(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad))(args))(function (v) {
                  var v1 = Data_List.last(v);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Do.value)(Data_List_Types.Nil.value));
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v1.value0);
                  };
                  throw new Error("Failed pattern match at Lang.Eval (line 215, column 3 - line 219, column 13): " + [ v1.constructor.name ]);
              });
          };
      };
  };
  var evalDef = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value1.value0))(function (v1) {
                      if (v.value0.value0 instanceof Lang_Core.Sym) {
                          return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(Lang_Core.updateEnv(dictMonad)(v.value0.value0.value0)(v1)))(function (v2) {
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v1);
                          });
                      };
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.SymTipe.value)(Lang_Core.toExprTipe(v.value0)));
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Def.value)(v));
          };
      };
  };
  var evalConz = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value1.value0))(function (v2) {
                          if (v2.value0 instanceof Lang_Core.Lst) {
                              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(new Lang_Core.ExprAnn(new Lang_Core.Lst(new Data_List_Types.Cons(v1, v2.value0.value0)), ann));
                          };
                          return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.LstTipe.value)(Lang_Core.toExprTipe(v2)));
                      });
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Conz.value)(v));
          };
      };
  };
  var evalCond = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Nil) {
                  return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Cond.value)(Data_List_Types.Nil.value));
              };
              var go = function (v1) {
                  if (v1 instanceof Data_List_Types.Cons && (v1.value0.value0 instanceof Lang_Core.Lst && (v1.value0.value0.value0 instanceof Data_List_Types.Cons && (v1.value0.value0.value0.value1 instanceof Data_List_Types.Cons && v1.value0.value0.value0.value1.value1 instanceof Data_List_Types.Nil)))) {
                      return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(Data_Functor.map(Coroutine.functorCoroutineT(Coroutine.functorYield)(Lang_Core.functorEvalT(((dictMonad.Bind1()).Apply0()).Functor0())))(Lang_Core.isTrue)($$eval(dictMonad)(v1.value0.value0.value0.value0)))(function (v2) {
                          if (v2) {
                              return $$eval(dictMonad)(v1.value0.value0.value0.value1.value0);
                          };
                          return go(v1.value1);
                      });
                  };
                  if (v1 instanceof Data_List_Types.Cons && v1.value0.value0 instanceof Lang_Core.Lst) {
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwLstLengthErr(Lang_Core.monadThrowEvalT(dictMonad))(v1.value0.value1)(2)(Data_Foldable.length(Data_List_Types.foldableList)(Data_Semiring.semiringInt)(v1.value0.value0.value0)));
                  };
                  if (v1 instanceof Data_List_Types.Cons) {
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.LstTipe.value)(Lang_Core.toExprTipe(v1.value0)));
                  };
                  if (v1 instanceof Data_List_Types.Nil) {
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwTrueCondClauseNotFound(Lang_Core.monadThrowEvalT(dictMonad))(ann));
                  };
                  throw new Error("Failed pattern match at Lang.Eval (line 316, column 5 - line 316, column 33): " + [ v1.constructor.name ]);
              };
              return go(v);
          };
      };
  };
  var evalCdr = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      if (v1.value0 instanceof Lang_Core.Lst && v1.value0.value0 instanceof Data_List_Types.Nil) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(new Lang_Core.ExprAnn(new Lang_Core.Lst(Data_List_Types.Nil.value), ann));
                      };
                      if (v1.value0 instanceof Lang_Core.Lst && v1.value0.value0 instanceof Data_List_Types.Cons) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(new Lang_Core.ExprAnn(new Lang_Core.Lst(v1.value0.value0.value1), ann));
                      };
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.LstTipe.value)(Lang_Core.toExprTipe(v1)));
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Cdr.value)(v));
          };
      };
  };
  var evalCar = function (dictMonad) {
      return function (ann) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
                  return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))($$eval(dictMonad)(v.value0))(function (v1) {
                      if (v1.value0 instanceof Lang_Core.Lst && v1.value0.value0 instanceof Data_List_Types.Nil) {
                          return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwLstLengthErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(1)(0));
                      };
                      if (v1.value0 instanceof Lang_Core.Lst && v1.value0.value0 instanceof Data_List_Types.Cons) {
                          return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v1.value0.value0.value0);
                      };
                      return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwWrongTipeErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.LstTipe.value)(Lang_Core.toExprTipe(v1)));
                  });
              };
              return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwSFrmNumArgsErr(Lang_Core.monadThrowEvalT(dictMonad))(ann)(Lang_Core.Car.value)(v));
          };
      };
  };
  var $$eval = function (dictMonad) {
      return function (v) {
          if (v.value0 instanceof Lang_Core.Sym) {
              return evalSym(dictMonad)(v.value1)(v.value0.value0);
          };
          if (v.value0 instanceof Lang_Core.Lst && (v.value0.value0 instanceof Data_List_Types.Cons && v.value0.value0.value0.value0 instanceof Lang_Core.SFrm)) {
              return evalSFrm(dictMonad)(v.value1)(v.value0.value0.value0.value0.value0)(v.value0.value0.value1);
          };
          if (v.value0 instanceof Lang_Core.Lst) {
              return evalLst(dictMonad)(v.value1)(v.value0.value0);
          };
          if (v.value0 instanceof Lang_Core.Float) {
              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v);
          };
          if (v.value0 instanceof Lang_Core.Integer) {
              return Coroutine.done(Lang_Core.monadEvalT(dictMonad))(v);
          };
          return Control_Monad_Trans_Class.lift(Coroutine.monadTransCoroutineT)(Lang_Core.monadEvalT(dictMonad))(throwUnknownErr(Lang_Core.monadThrowEvalT(dictMonad))(v.value1));
      };
  };
  var applyLambda = function (dictMonad) {
      return function (ann) {
          return function (localEnv) {
              return function (params) {
                  return function (args) {
                      return function (body) {
                          return Control_Bind.bind(Coroutine.bindCoroutineT(Coroutine.functorYield)(Lang_Core.monadEvalT(dictMonad)))(bindArgs(dictMonad)(ann)(localEnv)(params)(args))(function (v) {
                              return Coroutine.CoroutineT(Lang_Core.EvalT(Control_Monad_Except_Trans.mapExceptT(Control_Monad_State_Trans.withStateT(Data_Function["const"](v)))(Data_Newtype.unwrap(Lang_Core.newtypeEvalT)(Data_Newtype.unwrap(Coroutine.newtypeCoroutineT)($$eval(dictMonad)(body))))));
                          });
                      };
                  };
              };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Lang.Parser"] = $PS["Lang.Parser"] || {};
  var exports = $PS["Lang.Parser"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Lazy = $PS["Control.Lazy"];
      ...
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(location)(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(p)(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(location)(function (v2) {
                  ...
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.ExprAnn(v1, ann));
              });
          });
      });
  };
  var $$float = annotate(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Lang_Core.Float.create)(lexer["float"]));
  var integer = annotate(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Lang_Core.Integer.create)(lexer.integer));
  var number = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)($$float))(integer);
  var listOf = function (p) {
      return annotate(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Lang_Core.Lst.create)(lexer.parens(Data_List.manyRec(Text_Parsing_Parser.monadRecParserT(Control_Monad_Rec_Class.monadRecIdentity))(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(p))));
  };
  var quoted = function (p) {
      return annotate(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("'"))(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(annotate(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Quote.value))))(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(p)(function (v2) {
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.Lst(new Data_List_Types.Cons(v1, Control_Applicative.pure(Data_List_Types.applicativeList)(v2))));
              });
          });
      }));
  };
  var symbol = annotate(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.identifier)(function (v) {
      if (v === "car") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Car.value));
      };
      if (v === "cdr") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Cdr.value));
      };
      if (v === "cond") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Cond.value));
      };
      if (v === "cons") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Conz.value));
      };
      if (v === "define") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Def.value));
      };
      if (v === "do") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Do.value));
      };
      if (v === "equal?") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.IsEq.value));
      };
      if (v === "atom?") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.IsAtm.value));
      };
      if (v === "lambda") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Lambda.value));
      };
      if (v === "if") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.If.value));
      };
      if (v === "pause") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Pause.value));
      };
      if (v === "quote") {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.SFrm(Lang_Core.Quote.value));
      };
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lang_Core.Sym(v));
  }));
  var exprAnn = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(number)(symbol))(quoted(p)))(listOf(p));
  });                                                                                        
...
(function($PS) {
  ...
  var Lang_Core = $PS["Lang.Core"];
  var Lang_Eval = $PS["Lang.Eval"];
  var Lang_Parser = $PS["Lang.Parser"];                
  var src = "(do (pause) (define id (lambda (x) x)) (pause) (define foo 123) (do (cons 'x '()) (pause) (car '(z y x))) (pause) (cons '(x) '(y)))";
  var bindings = Data_Monoid.mempty(Lang_Core.monoidBindings(Lang_Core.monoidPrimFns));
  var main = function __do() {
      var v = Lang_Core.runEvalT(Effect.monadEffect)(bindings)((function () {
          var v = Lang_Parser.parseOne(src);
          if (v instanceof Data_Either.Left) {
              var v1 = Debug_Trace.spy()("parseErr")(v.value0);
              return Control_Applicative.pure(Lang_Core.applicativeEvalT(Effect.monadEffect))(Data_Unit.unit);
          };
          if (v instanceof Data_Either.Right) {
              var v1 = Debug_Trace.spy()("parsed")(v.value0);
              return Control_Bind.bind(Lang_Core.bindEvalT(Effect.monadEffect))(Coroutine.bounce(Lang_Eval["eval"](Effect.monadEffect)(v.value0)))(function (v2) {
                  if (v2 instanceof Data_Either.Left) {
                      var v3 = Debug_Trace.spy()("env1")(v2.value0.value0);
                      return Control_Bind.bind(Lang_Core.bindEvalT(Effect.monadEffect))(Coroutine.bounce(v2.value0.value1(Data_Unit.unit)))(function (v4) {
                          if (v4 instanceof Data_Either.Left) {
                              var v5 = Debug_Trace.spy()("env2")(v4.value0.value0);
                              return Control_Bind.bind(Lang_Core.bindEvalT(Effect.monadEffect))(Coroutine.bounce(v4.value0.value1(Data_Unit.unit)))(function (v6) {
                                  if (v6 instanceof Data_Either.Left) {
                                      var v7 = Debug_Trace.spy()("env3")(v6.value0.value0);
                                      return Control_Bind.bind(Lang_Core.bindEvalT(Effect.monadEffect))(Coroutine.bounce(v6.value0.value1(Data_Unit.unit)))(function (v8) {
                                          if (v8 instanceof Data_Either.Left) {
                                              var v9 = Debug_Trace.spy()("env4")(v8.value0.value0);
                                              return Control_Applicative.pure(Lang_Core.applicativeEvalT(Effect.monadEffect))(Data_Unit.unit);
                                          };
                                          if (v8 instanceof Data_Either.Right) {
                                              var v9 = Debug_Trace.spy()("done4")(Data_Show.show(Lang_Core.showExprAnn)(v8.value0));
                                              return Control_Applicative.pure(Lang_Core.applicativeEvalT(Effect.monadEffect))(Data_Unit.unit);
                                          };
                                          throw new Error("Failed pattern match at Main (line 41, column 21 - line 47, column 34): " + [ v8.constructor.name ]);
                                      });
                                  };
                                  if (v6 instanceof Data_Either.Right) {
                                      var v7 = Debug_Trace.spy()("done3")(Data_Show.show(Lang_Core.showExprAnn)(v6.value0));
                                      return Control_Applicative.pure(Lang_Core.applicativeEvalT(Effect.monadEffect))(Data_Unit.unit);
                                  };
                                  throw new Error("Failed pattern match at Main (line 37, column 17 - line 50, column 30): " + [ v6.constructor.name ]);
                              });
                          };
                          if (v4 instanceof Data_Either.Right) {
                              var v5 = Debug_Trace.spy()("done2")(Data_Show.show(Lang_Core.showExprAnn)(v4.value0));
                              return Control_Applicative.pure(Lang_Core.applicativeEvalT(Effect.monadEffect))(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at Main (line 33, column 13 - line 53, column 26): " + [ v4.constructor.name ]);
                      });
                  };
                  if (v2 instanceof Data_Either.Right) {
                      var v3 = Debug_Trace.spy()("done1")(Data_Show.show(Lang_Core.showExprAnn)(v2.value0));
                      return Control_Applicative.pure(Lang_Core.applicativeEvalT(Effect.monadEffect))(Data_Unit.unit);
                  };
                  throw new Error("Failed pattern match at Main (line 29, column 9 - line 56, column 22): " + [ v2.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Main (line 22, column 5 - line 56, column 22): " + [ v.constructor.name ]);
      })())();
      var v1 = Debug_Trace.spy()("final")(Data_Show.show(Data_Either.showEither(Lang_Core.showEvalErr)(Data_Unit.showUnit))(v.value0));
